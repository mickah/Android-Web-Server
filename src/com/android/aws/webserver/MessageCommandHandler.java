...
import com.android.aws.ui.AWSMessageActivity;
import com.android.aws.utility.Utility;
...
public class MessageCommandHandler implements HttpRequestHandler{
	private static final long[] VIBRATE = {0,100};
	...
	public void handle(HttpRequest request, HttpResponse response, HttpContext httpContext) throws HttpException, IOException {
		AppLog.logString("http request handle");
